...
export const allHotels = async () => await axios.get(
...
export const read = async (hotelId) => await axios.get(
...
await axios.put(
  `${process.env.REACT_APP_API}/update-hotel/${hotelId}`,data,{
      headers: {
          Authorization: `Bearer ${token}`,
      },
  }
...
export const userHotelBookings = async (token) => await axios.get(
...
export const searchListings = async (query) => await axios.post(
  `${process.env.REACT_APP_API}/search-listing`,query
)
